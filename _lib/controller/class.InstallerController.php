...
class InstallerController extends ThinkUpController {
    ...
    private function step2() {
        ...
        require $config_file;
            ...
            $this->addToView('db_name', $THINKUP_CFG['db_name']);
            $this->addToView('db_user', $THINKUP_CFG['db_user']);
            $this->addToView('db_passwd', $THINKUP_CFG['db_password']);
            $this->addToView('db_host', $THINKUP_CFG['db_host']);
            $this->addToView('db_prefix', $THINKUP_CFG['table_prefix']);
            $this->addToView('db_socket', $THINKUP_CFG['db_socket']);
            $this->addToView('db_port', $THINKUP_CFG['db_port']);
            $this->addToView('db_type', $THINKUP_CFG['db_type']);
