...
//Parse VCAP_SERVICES into usable variables
$services = getenv("VCAP_SERVICES");
$services_json = json_decode($services,true);
$mysql_config = $services_json["mysql-5.1"][0]["credentials"];


$THINKUP_CFG['db_host']                   = $mysql_config['hostname']; //On a shared host? Try mysql.yourdomain.com, or see your web host's documentation.
$THINKUP_CFG['db_type']                   = 'mysql';
$THINKUP_CFG['db_user']                   = $mysql_config['user'];
$THINKUP_CFG['db_password']               = $mysql_config['password'];
$THINKUP_CFG['db_name']                   = $mysql_config['name'];
$THINKUP_CFG['db_socket']                 = '';
$THINKUP_CFG['db_port']                   = $mysql_config['port'];
